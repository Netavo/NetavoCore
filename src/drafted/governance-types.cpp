...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "NETAVONetwork") type = NETAVONetwork;
    if(strType == "NETAVONetworkVariable") type = NETAVONetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == NETAVONetwork) s = "NETAVONetwork";
    if(type == NETAVONetworkVariable) s = "NETAVONetworkVariable";
