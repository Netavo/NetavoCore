...
NETAVO Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 15221.
...
However, in open source software such as NETAVO Core, where everyone uses
...
pay attention to for reviewers of NETAVO Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: NETAVO Core uses tinyformat, which is type safe. Leave them out to avoid confusion
