 ...
 *
 *   // network
 *   CNETAVONetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.netavo.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CNETAVONetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: NETAVONetwork
// //   -- signature requirements : Key1(User)
// class CNETAVONetworkVariable : public CGovernanceObject
// {
// private:
