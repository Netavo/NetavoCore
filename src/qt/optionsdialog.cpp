    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("AVO-light"), QVariant("light"));
    ui->theme->addItem(QString("AVO-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("AVO-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("AVO-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("AVO-traditional"), QVariant("trad"));
