...
Only requiring some minor changes is netavo.cpp.
...
Changes to netavo.cpp
----------------------
netavo.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
