...
This mechanism has been integrated into Bitcore-Node-NETAVO which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/netavoproject/insight-api-netavo#web-socket-api](https://github.com/netavoproject/insight-api-netavo#web-socket-api)
* API: [https://github.com/netavoproject/insight-api-netavo#instantsend-transactions](https://github.com/netavoproject/insight-api-netavo#instantsend-transactions)
...
By default, the NETAVO Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the NETAVO Core daemon:
