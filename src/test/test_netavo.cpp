...
#define BOOST_TEST_MODULE NETAVO Test Suite

#include "test_netavo.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_netavo_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
