    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("NETAVO Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NETAVO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and netavo: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About NETAVO Core"), this);
    aboutAction->setStatusTip(tr("Show information about NETAVO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NETAVO Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NETAVO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NETAVO addresses"));
    ...
    openAction->setStatusTip(tr("Open a netavo: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NETAVO Core help message to get a list with possible NETAVO Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("NETAVO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NETAVO network", "", count));
    } else {
...
{
    QString strTitle = tr("NETAVO Core"); // default title
