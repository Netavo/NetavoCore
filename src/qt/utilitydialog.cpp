    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("NETAVO Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About NETAVO Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  netavo-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the NETAVO in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an innovative process to mix your inputs with the inputs of two other netavo, without having your coins ever leave your wallet. \
...
These denominations are 0.01 AVO, 0.1 AVO, 1 AVO and 10 AVO -- sort of like the paper money you use every day.</li> \
...
<li>When two other netavo send similar messages, indicating that they wish to mix the same denomination, a mixing session begins. \
...
For more info see <a href=\"https://NETAVODev.atlassian.net/wiki/display/DOC/PrivateSend\">https://NETAVODev.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("NETAVO Core is shutting down...") + "<br /><br />" +
